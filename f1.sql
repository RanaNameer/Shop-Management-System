...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 18, 2022 at 01:35 PM
...
('Bilal', 'Bilal', '+923331903603', 'Pakistan ,Pakistan'),
('rana_378', 'Nameer', '+923091001405', 'Nust,Islamabad');
...
('e001', 'Employee1', '+925436789765', 'Manager', 50000.00),
('e002', 'Employee2', '+928761236589', 'General', 30000.00);
...
('e001', 'admin123', 0),
('e002', 'e001', 0),
('Bilal', 'Pakistani123', 1),
('qwert', 'Pakijhjg0', 1),
('rana_378', 'Pakistan123', 1);
...
(00007, 'c001', '00001', 66.00, 1, '2022-04-12'),
(00008, 'c001', '1', 66.00, 1, '2022-04-16');
...
--
ALTER TABLE `product`
  MODIFY `productId` int(5) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `purchaseinfo`
--
ALTER TABLE `purchaseinfo`
  MODIFY `purchaseId` int(5) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
